...
const PHASES=[{num:0,name:"Qualification",color:"#7AB648",desc:"Validate minimum required inputs via Filecard."},{num:1,name:"Internal Layout Direction",color:"#E8384F",desc:"Create initial floorplan layout in E-planner."},{num:2,name:"Internal Budget Commitment",color:"#FD9A00",desc:"Collect supplier quotes. Evaluate ROI."},{num:3,name:"Customer Layout Approval",color:"#EEC300",desc:"Partner approval of layout package."},{num:4,name:"Technical Freeze",color:"#E8D500",desc:"Lock technical specifications."},{num:5,name:"Commercial Approval",color:"#A4CF30",desc:"Brand + HoR approval of scope and investment."},{num:6,name:"Production & Order Lock",color:"#4ECBC4",desc:"Formal PROJECT GO. Production begins."},{num:7,name:"Installation Planning",color:"#37C5AB",desc:"Readiness checks. Final confirmations."},{num:8,name:"Delivery & Installation",color:"#4186E0",desc:"Execute delivery and installation on-site."},{num:9,name:"Merchandising & Opening",color:"#7A6FF0",desc:"Opening report. Screen content deployment."},{num:10,name:"Close & Learning",color:"#AA62E3",desc:"ROI follow-up. Performance deck."}];
...
<div class="ft"><span>Selected Frame · Brand Spaces</span><span>Confidential</span></div>
  ...
  return<div><Title sub="Upload a supplier quotation PDF to generate a branded project quotation">Quotation Builder</Title>
    ...
    {parsed&&<div style={{marginBottom:32}}><Title sub="From supplier quotation – click amounts to edit">Cost Breakdown</Title><div style={{background:C.white,borderRadius:8,padding:24,border:`1px solid ${C.surfaceD}`}}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16,marginBottom:16}}><ET label="Inventory" field="inventory"/><ET label="Selected Deliveries" field="selectedDeliveries"/><ET label="Specific Project Cost" field="specificProjectCost"/></div>
